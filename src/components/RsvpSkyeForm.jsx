...
export default function RsvpSkyeForm({ childName, eventDetails, onRsvpSubmitted }) {
  ...
  return (
    <section id="rsvp" className="max-w-3xl mx-auto px-4 py-12 relative z-10">
      
      <div className="skye-card border-4 border-pink-300 shadow-2xl relative overflow-hidden">
        
        {/* Decorative Top Banner */}
        <div className="bg-gradient-to-r from-pink-500 via-rose-400 to-sky-400 -mx-8 -mt-8 p-6 text-center text-white mb-6">
          <div className="paw-badge mb-2 bg-white/20 border-white text-white">
            <span>🐾 Confirmación de Asistencia (RSVP) 🐾</span>
          </div>
          <h2 className="text-3xl sm:text-4xl font-extrabold font-heading drop-shadow">
        ...
        {submitted ? (
          <div className="py-8 text-center animate-glow">
            <div className="w-20 h-20 bg-green-100 border-4 border-green-400 text-green-500 rounded-full flex items-center justify-center mx-auto mb-4 animate-bounce-slow">
              <CheckCircle2 className="w-12 h-12" />
            </div>
            
            <h3 className="text-3xl font-extrabold text-pink-600 font-heading mb-2">
              ¡Respuesta Registrada con Éxito! 🎉
            </h3>
            
            <p className="text-gray-700 font-medium text-lg mb-6 max-w-md mx-auto">
            ...
            {formData.status === 'confirmed' && (
              <>
                <div className="max-w-md mx-auto mb-6 p-4 bg-amber-50 rounded-2xl border-2 border-amber-200 shadow-sm text-center">
                  <h4 className="text-amber-700 font-bold font-heading mb-1 text-sm flex items-center justify-center gap-1.5">
                    🎁 Una pequeña nota sobre los regalitos
                  </h4>
                  <p className="text-amber-700/90 text-xs font-medium leading-relaxed">
                ...
                <div className="max-w-xl mx-auto mb-8 p-6 bg-pink-50/50 rounded-2xl border-2 border-pink-100">
            ...
            <button
              ...
              className="btn-skye-secondary text-sm"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-1 font-heading">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-2xl border-2 border-pink-200 focus:border-pink-500 focus:outline-none font-medium text-gray-800"
                />
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className={`p-4 rounded-2xl border-3 flex flex-col items-center gap-2 font-bold transition-all ${
                    formData.status === 'confirmed'
                ...
                >
                  ...
                  <span className="font-heading">¡Sí, ahí estaré! 💖</span>
                </button>
                ...
                >
                  ...
                  <span className="font-heading">No podré asistir 😢</span>
                </button>
              </div>
            </div>
            ...
            {formData.status === 'confirmed' && (
              <div className="space-y-6 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 bg-pink-50/80 rounded-2xl border-2 border-pink-200">
                  <div>
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-1 flex items-center gap-1 font-heading">
                    <Utensils className="w-4 h-4 text-pink-500" /> Alergias o dietas especiales (Opcional)
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-1 flex items-center gap-1 font-heading">
                    <Music className="w-4 h-4 text-amber-500" /> Canción favorita para bailar en la fiesta (Opcional)
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-1 flex items-center gap-1 font-heading">
                    <MessageCircle className="w-4 h-4 text-rose-500" /> Mensajito especial para {childName} (Opcional)
                  </label>
                  <textarea
                    rows={3}
            ...
            <button
              ...
              className="w-full btn-skye-primary py-4 text-xl flex items-center justify-center gap-2 shadow-xl"
            >
              {isSubmitting ? (
